            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 flex flex-col justify-between bg-[#121212] border-t md:border-t-0 md:border-l border-white/5">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/5 mt-auto">
                  ...
                  <a
                    href={`https://wa.me/6282114507599?text=Halo%20PrimaSpace,%20saya%20tertarik%20dengan%20proyek%20kontraktor%20seperti%20${encodeURIComponent(selectedProject.title)}`}
                    target="_blank"
